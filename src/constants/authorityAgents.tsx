...
export const AUTHORITY_AGENTS: AuthorityAgentDef[] = [
  ...
  { key: "social_proof", name: "Rafa Reputação", label: "Agente Prova social e reputação", desc: "Scripts e ativos para coletar e publicar prova social.", Icon: Star },
  ...
  { key: "cross_platform_consistency", name: "Nina Consistência", label: "Agente Consistência", desc: "Padronização de mensagens e identidade entre canais.", Icon: Merge },
